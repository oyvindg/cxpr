...
typedef enum {
    ...
    CXPR_IR_VIEW_OP_LOAD_VAR_SQUARE,
    CXPR_IR_VIEW_OP_LOAD_PARAM,
    CXPR_IR_VIEW_OP_LOAD_PARAM_SQUARE,
    CXPR_IR_VIEW_OP_LOAD_FIELD,
    CXPR_IR_VIEW_OP_LOAD_FIELD_SQUARE,
    CXPR_IR_VIEW_OP_LOAD_NAMED_FIELD,
    CXPR_IR_VIEW_OP_LOAD_CHAIN,
    CXPR_IR_VIEW_OP_ADD,
    CXPR_IR_VIEW_OP_SUB,
    CXPR_IR_VIEW_OP_MUL,
    CXPR_IR_VIEW_OP_SQUARE,
    CXPR_IR_VIEW_OP_DIV,
    CXPR_IR_VIEW_OP_MOD,
    CXPR_IR_VIEW_OP_CMP_EQ,
    CXPR_IR_VIEW_OP_CMP_NEQ,
    CXPR_IR_VIEW_OP_CMP_LT,
    CXPR_IR_VIEW_OP_CMP_LTE,
    CXPR_IR_VIEW_OP_CMP_GT,
    CXPR_IR_VIEW_OP_CMP_GTE,
    CXPR_IR_VIEW_OP_NOT,
    CXPR_IR_VIEW_OP_NEG,
    CXPR_IR_VIEW_OP_SIGN,
    CXPR_IR_VIEW_OP_SQRT,
    CXPR_IR_VIEW_OP_ABS,
    CXPR_IR_VIEW_OP_FLOOR,
    CXPR_IR_VIEW_OP_CEIL,
    CXPR_IR_VIEW_OP_ROUND,
    CXPR_IR_VIEW_OP_POW,
    CXPR_IR_VIEW_OP_CLAMP,
    CXPR_IR_VIEW_OP_CALL_PRODUCER,
    CXPR_IR_VIEW_OP_CALL_PRODUCER_CONST,
    CXPR_IR_VIEW_OP_CALL_PRODUCER_CONST_FIELD,
    CXPR_IR_VIEW_OP_GET_FIELD,
    CXPR_IR_VIEW_OP_CALL_UNARY,
    CXPR_IR_VIEW_OP_CALL_BINARY,
    CXPR_IR_VIEW_OP_CALL_TERNARY,
    CXPR_IR_VIEW_OP_CALL_FUNC,
    CXPR_IR_VIEW_OP_CALL_DEFINED,
    CXPR_IR_VIEW_OP_CALL_AST,
    CXPR_IR_VIEW_OP_JUMP,
    CXPR_IR_VIEW_OP_JUMP_IF_FALSE,
    CXPR_IR_VIEW_OP_JUMP_IF_TRUE,
    CXPR_IR_VIEW_OP_LOOKBACK_PUSH,
    CXPR_IR_VIEW_OP_LOOKBACK_POP,
