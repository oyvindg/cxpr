...
static const cxpr_window_ir window_ops[] = {
    {CXPR_WINDOW_OP_ROC, "__cxpr_window_roc", 2u, 1u, 1u, CXPR_WINDOW_REDUCE_NONE},
    {CXPR_WINDOW_OP_SUM, "__cxpr_window_sum", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_SUM},
    {CXPR_WINDOW_OP_MEAN, "__cxpr_window_mean", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_MEAN},
    {CXPR_WINDOW_OP_WMA,
     "__cxpr_window_wma", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_WEIGHTED_MEAN},
    {CXPR_WINDOW_OP_STDDEV,
     "__cxpr_window_stddev", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_STDDEV},
    {CXPR_WINDOW_OP_HIGHEST,
     "__cxpr_window_highest", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_HIGHEST},
    {CXPR_WINDOW_OP_LOWEST,
     "__cxpr_window_lowest", 2u, 1u, 0u, CXPR_WINDOW_REDUCE_LOWEST},
    {CXPR_WINDOW_OP_BARS_SINCE_EXTREME,
     "bars_since_extreme", 3u, 1u, 0u, CXPR_WINDOW_REDUCE_NONE},
    {CXPR_WINDOW_OP_MEAN_ABSDEV,
     "__cxpr_window_mean_absdev", 3u, 1u, 0u, CXPR_WINDOW_REDUCE_NONE},
};
